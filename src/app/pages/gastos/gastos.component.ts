...
// ];
    ...
    // this.transacoesService.getTransacoesObservable("cris"); /// faz a request
    // this.transacoesService.getTransacoesObservable("cris")
    //   .subscribe(transacoes =>
    //     {
    //     this.transacoes$ = transacoes;
    ...
    // this.transacoesService.getTransacoes("cris"); /// faz a request
    // this.transacoesService.getTransacoes("cris")
    //   .subscribe(transacoes => {
    //     this.transacoes = transacoes;
